...
void GenerateMap3( int PlayerX, int PlayerY, int ChaveX, int ChaveY, int PortaX, int PortaY, int monsteX, int monsteY,int monste2X,int monste2Y, int BotaoX, int BotaoY);{
    char layout3 [43][43] = {
        "\t\t\t*****************************************",
        "\t\t\t**       &         *         #@#       **",
        "\t\t\t*                  *         # #        *",
